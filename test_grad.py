...
from multilat import Point, Beacon, generate_triangle_points, grad_func, great_circle_distance, overlap_error, error_component_regular, error_component_maximize, error_component_minimize, great_circle_distance, get_point_at_distance_and_bearing, normalize_gradient_components
...
class TestGradMethods(unittest.TestCase):
    ...
    def do_gradient_test_at_point(self, test_point):
        ...
        self.assertTupleAlmostEqual(grad, grad_approx, 2)     
